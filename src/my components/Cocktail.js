...
export default function Cocktail() {
  ...
  const bridalHD = process.env.REACT_APP_COCKTAIL_HD || "PRICE NOT FOUND"; 
  const bridalAir = process.env.REACT_APP_COCKTAIL_AIR || "PRICE NOT FOUND";

  return (
    <div className='section Cocktail'>
      <div className='MainServiceContainer'>
        ...
        <div className='ServiceTitleContainer'>
          ...
          <motion.span className='ServiceTitle' initial="hidden" animate="visible" exit="exit" variants={titleEntryVariant}>Cocktail Makeup</motion.span>
