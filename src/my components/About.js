  ...
  return (
    <div id='about' className='section About'>
      <div className='MainAboutContainer'>
        <a target="_blank" rel="noreferrer" href="https://www.instagram.com/p/CnGf2-SvqaJ/" className="AboutImageContainer"><img className='AboutPicture' src={require('./Images/about.webp')} alt='ABOUT'/></a>
